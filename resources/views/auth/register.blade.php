            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }} ">
                        ...
                        <div class="row mb-3">
                            <label for="mata_kuliah" class="col-md-4 col-form-label text-md-end text-dark">{{ __('Mata Kuliah') }}</label>

                            <div class="col-md-6">
                                <input id="mata_kuliah" type="text" class="form-control @error('mata_kuliah') is-invalid @enderror" name="mata_kuliah" value="{{ old('mata_kuliah') }}">
