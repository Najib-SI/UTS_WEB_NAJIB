...
@if (Route::has('login'))
    <div class="auth">
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header text-lg text-dark" style="text-align: center; margin-bottom: 20px;"><img src="{{ asset('img/unsia.png') }}" style="max-height: 50px; width: auto; height: auto;" alt="logo"></div>
                <div class="card-body">
