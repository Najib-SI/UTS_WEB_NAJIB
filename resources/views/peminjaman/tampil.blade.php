...
@section('judul')
    <h1 style="color: #10487a;">Daftar Riwayat Peminjaman</h1>
@endsection
...
@section('content')
    ...
    <!-- <div class="container"> -->
        <a href="/peminjaman/create" class="btn mb-3 " style="background-color: #10487a; color: #fff; border: none;"><i class="fa-solid fa-plus"></i> Tambah Peminjaman</a>
