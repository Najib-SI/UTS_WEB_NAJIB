...
@section('judul')
    <h2 style="color: #10487a;">Daftar Siswa</h2>
@endsection
...
@if (Auth::user()->isAdmin == 1)
    <a href="/siswa/create" class="btn mb-3" style="background-color: #10487a; color: #fff; border: none;"><i class="fa-solid fa-plus"></i> Tambah Siswa</a>
@endif
    ...
    <div class="col-lg-12">
        <div class="card mb-4">
                    ...
                    <tbody>
                        @forelse ($anggota as $key => $item)
                            <tr>
                                ...
                                <td>{{ $item->profile->mata_kuliah }}</td>
                                <td>

                                    @if (Auth::user()->isAdmin == 1)
                                        <button class="btn btn-info"><a href="/siswa/{{ $item->id }}"
                                                style="text-decoration: none; color:white;"><i class="fa-solid fa-circle-info"></i></a></button>
                                        <button class="btn btn-warning"><a href="/siswa/{{ $item->id }}/edit"
            ...
            @if (Auth::user()->isAdmin == 0)
                <a href="/siswa/{{ $item->id }}" class="btn-sm btn-info px-3 py-2"><i class="fa-solid fa-circle-info"></i></a>
            @endif
