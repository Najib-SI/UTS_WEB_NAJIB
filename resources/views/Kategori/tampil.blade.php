...
@section('judul')
    <h2 style="color: #10487a;">Daftar Kategori</h2>
@endsection
...
@section('content')
    @if (Auth::user()->isAdmin == 1)
        <a href="/kategori/create" class="btn mb-3" style="background-color: #10487a; color: #fff; border: none;"><i class="fa-solid fa-plus"></i> Tambah Kategori</a>
    @endif
