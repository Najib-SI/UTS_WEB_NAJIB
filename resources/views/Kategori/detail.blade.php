...
@section('judul')
    <h2 style="color: #10487a;">Detail Kategori</h2>
@endsection

@section('content')
    <div class="card">
        <h3 class="judul m-3" style="font-weight:bold; color: #10487a;">{{ $kategori->nama }}</h3>
    ...
    <h4 class="m-3" style="font-weight: bold; color: #10487a;">Buku Terkait Kategori :</h4>
